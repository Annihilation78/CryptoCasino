        ...
        <div className="support-container">
            ...
            <div className="support-div">
                ...
                <ul className="support-list">
                    ...
                    <li><h1 className="support-h1">Depósitos y Retiros</h1></li>
                    ...
                    <li><h1 className="support-h1">Bonos y Promociones</h1></li>
